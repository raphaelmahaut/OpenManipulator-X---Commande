...
def structure(name):
    S = {'tas': [(0., 0.09, 0.05, 90, "ouvrir"), (0., 0.09, 0., 90, "fermer"), (0., 0.09, 0.05, 90, "fermer"),
                 (0.2, 0., 0.05, 90, "fermer"), (0.2, 0., 0.,
                                                 90, "ouvrir"), (0.2, 0., 0.05, 90, "ouvrir"),
                 (0., -0.09, 0.05, 90, "ouvrir"), (0., -0.09, 0.0,
                                                   90, "fermer"), (0., -0.09, 0.05, 90, "fermer"),
                 (0.2, 0., 0.05, 90, "fermer"), (0.2, 0., 0.009,
                                                 90, "ouvrir"), (0.2, 0., 0.05, 90, "ouvrir"),
                 ], 'dolmen': [(0., 0.09, 0.07, 90, "ouvrir"), (0., 0.09, 0.031, 90, "fermer"), (0., 0.09, 0.07, 90, "fermer"),
                               (0.25, 0., 0.08, -0.1, "fermer"), (0.25, 0.,
                                                                  0.062, -0.1, "ouvrir"), (0.18, 0., 0.08, 90, "ouvrir"),
                               (0., -0.09, 0.07, 90, "ouvrir"), (0., -0.09, 0.027,
                                                                 90, "fermer"), (0., -0.09, 0.07, 90, "fermer"),
                               (0.21, 0., 0.08, 0., "fermer"), (0.204, 0.,
                                                                0.058, 0., "ouvrir"), (0.1, 0., 0.08, 90, "ouvrir"),
                               (0., 0.09, 0.07, 90, "ouvrir"), (0., 0.09, 0.027,
                                                                90, "fermer"), (0., 0.09, 0.15, 90, "fermer"),
                               (0.1, 0.05, 0.07, 90, "fermer"), (0.1, 0.05, 0.027, 90,
                                                                 "ouvrir"), (0.1, 0.05, 0.018, 1., "fermer"), (0.1, 0.05, 0.16, 1., "fermer"),
                               (0.24, 0., 0.16, 1., "fermer"), (0.24, 0., 0.152, 1., "ouvrir"), (0.1, 0., 0.15,
                                                                                                 1., "ouvrir"), (0., 0.09, 0.15, 1., "ouvrir"),  (0., 0.09, 0.03, 1., "ouvrir"),
                               ], 'test': [(0.2, 0., 0.2, 0., "ouvrir"), (0.076, 0.060, 0.028, 90, "ouvrir"), (0.2, 0., 0.2, 0., "ouvrir"), (0.197, -0.124, 0.028, 90, "ouvrir")], 'demande': [(0., 0.09, 0.07, 90, "ouvrir")]}
    return S[name]
...
def securite(mouvement, information):
    ...
    list_point = trajectoire(pos_act[:4], (0.2, 0., 0.), 0.05, "cadre", 40)
    tps = 3.0/len(list_point)
    while list_point:
...
def bougeage(mouvement, information, obj):
    ...
    if obj[y] >= 0:
        list_point = trajectoire(pos_act[:4], ((r - 0.05)*np.sin(
            th1 + 3*np.pi/180), (r - 0.05)*np.cos(th1 + 3*np.pi/180), 0.002), 0.05, "cadre", 40)
    else:
        list_point = trajectoire(pos_act[:4], ((r - 0.05)*np.sin(
            th1 - 3*np.pi/180), (r - 0.05)*np.cos(th1 - 3*np.pi/180), 0.002), 0.05, "cadre", 40)
    tps = 3.0/len(list_point)
...
def main(args=None, hmax=5):
    ...
    positions = structure("tas")

    n = 0
    vide = True

    for x, y, z, th, o in positions:
        if rclpy.ok():
            rclpy.spin_once(information)

            mouv(mouvement, x, y, z, th, 2.0)
            time.sleep(2)
            if o != ouverture:
                prise(mouvement, o, 2.0)
                time.sleep(2)
                ouverture = o
